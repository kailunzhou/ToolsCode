...
public extension NetMethod {
    ...
    ///获取用户注册协议内容
    func getRegistProtocol(_ type: String?, _ view: UIView?, okAction: @escaping (_ dataDic: [String: Any]?)->()) {
    ...
    ///获取验证码
    func getCode(_ mobile: String?, _ type: String?, _ view: UIView?, okAction : @escaping ()->()) {
    ...
    ///校验验证码
    func checkCode(_ mobile: String?, _ type: String?, _ view: UIView?, _ vcode: String?, okAction: @escaping ()->()) {
